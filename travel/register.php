            ...
            <div class="tm-container-outer tm-register-bg">
                <div class="container">
                    ...
                    <div class="tm-container-outer tm-position-relative" id="tm-section-4">
                        ...
                        <form action="register-post.php" method="post" class="tm-contact-form" enctype="multipart/form-data">
                            ...
                            <div class="form-group tm-email-container">
                                <input type="text" id="matrixno" name="matrixno" class="form-control"
                                    placeholder="matrix Number" required />
                            </div>
                            <div class="form-group tm-email-container">
